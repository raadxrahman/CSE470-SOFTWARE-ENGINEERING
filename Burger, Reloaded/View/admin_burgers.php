	...
	<section id="header">
		<div class="row">  
			...
			<div class="col-md-10" style="text-align: right"> <br>
				...
				<a href="../Controller/admin_remove_burgers.php" style="margin-left: 20px;"> Delete Burgers </a>
	...
	<section id = "section1">
		...
		<div style="color: black; margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:white; opacity:95%;">
			...
			<div class="row" style="padding:5px;"> 
				...
				<form action="../Model/admin_remove_burgers_backend.php" method="POST">
	...
	<section id="footer"> 
        ...
        <div class="border border-light p-3 mb-4">
          ...
          <div class="text-center">
			...
			<a href="../Controller/admin_add_burgers.php">Add Burgers</a></button>
