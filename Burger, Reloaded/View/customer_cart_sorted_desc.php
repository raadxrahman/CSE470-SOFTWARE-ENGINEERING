  ...
  <body> 
	...
	<section id = "section1">
		...
		<div style="color: black; margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:white; opacity:95%;">
			...
			$sql = "SELECT * FROM cart ORDER BY Price desc";
	...
	<div class="border border-light p-3 mb-4">
		...
		<div class="text-center">
		  <button type="button" class="btn btn-primary" style="background-color:green;border-radius: 12px;"> <a href="customer_cart.php">
			  Default</a></button>
