      ...
      <div class="main">
         <div class="col-md-6 col-sm-12">
            <div class="login-form">
               <form action ="../Model/customer_apply_job_backend.php" class="form_design" method="post">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                     <label style = "font-weight : bold ; font-family : Courier New">Experience</label>
                     <input type="text" name = "qualifications" class="form-control" placeholder="Experience (in Years); Example - 3">
                  </div>
