...
<script src="https://kit.fontawesome.com/1dd1f69d41.js" crossorigin="anonymous"></script>
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
			<div class="col-md-2" style="font-size: 35px;color:#F2674A; font-family: Times New Roman;"> <a href ="customer_home.php">Burger, </br>Reloaded </a></div>
	...
	<section id="footer"> 
        ...
        <div class="border border-light p-3 mb-4">
          ...
          <div class="text-center">
            <button type="button" class="btn btn-primary" style="background-color:green;border-radius: 12px;"> <a href="customer_apply_job.php">Apply to a job!</a></button>
