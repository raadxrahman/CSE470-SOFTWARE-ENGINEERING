	...
	<section id="header">
		<div class="row">  
			...
			<div class="col-md-10" style="text-align: right"> <br>
				...
				<a href="../Controller/admin_remove_addons.php" style="margin-left: 20px;"> Delete Add-Ons </a>
	...
	<section id = "section1">
		...
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:white; opacity:95%;">
			...
			<div class="row" style="padding:5px;"> 
				...
				<form action="../Controller/admin_remove_addons.php" method="POST"><input type="hidden" name="id" value=<?php echo $row[0] ?>>
	...
	<section id="footer"> 
        ...
        <div class="border border-light p-3 mb-4">
          ...
          <div class="text-center">
            <button type="button" class="btn btn-primary"style="background-color:green;border-radius: 12px;"> <a href="../Controller/admin_add_addons.php">Add Add-Ons</a></button>
