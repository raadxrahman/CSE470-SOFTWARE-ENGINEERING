...
<script src="https://kit.fontawesome.com/1dd1f69d41.js" crossorigin="anonymous"></script>
  ...
  <body> 
	...
	<section id="header">
		<div class="row">  
			<div class="col-md-2" style="font-size: 35px; font-family: Times New Roman;"> <a href ="../Controller/admin_home.php">Burger, </br>Reloaded </a></div>
	...
	<section id = "section1">
		...
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:white; opacity:95%;">
			...
			<div class="row" style="padding:5px;"> 
				...
				<input type="hidden" name="addon_id" value=<?php echo $row[0] ?>>
				<input type="hidden" name="addon_name" value=<?php echo $row[1] ?>>
				<input type="hidden" name="addon_price" value=<?php echo $row[2] ?>>
