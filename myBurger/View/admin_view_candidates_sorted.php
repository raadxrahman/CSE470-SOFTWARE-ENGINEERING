<html lang="en">
  <head>
      ...
      <title> Admin:candidates+sorted </title>
  ...
  <body> 
	...
	<section id = "section1">
		...
		<div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:white; opacity:95%;">
			...
			$sql = "SELECT * FROM job_candidates ORDER BY qualifications desc";
	...
	<section id="footer"> 
        ...
        <div class="border border-light p-3 mb-4">
		  ...
		  <button type="button" class="btn btn-primary"style="background-color:green;border-radius: 12px;"> 
			<a href="admin_view_candidates.php">Default</a></button></br></br></br></br>
