...
<script src="https://kit.fontawesome.com/1dd1f69d41.js" crossorigin="anonymous"></script>
  <head>
      ...
      <title> Burgers High to Low</title>
  ...
  <body> 
	...
	<section id = "section1">
		...
		<div style="color: black; margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:white; opacity:95%;">
			...
			$sql = "SELECT * FROM burgers ORDER BY burger_price DESC";
			...
			<div class="row" style="padding:5px;"> 
				...
				<input type="hidden" name="burger_name" value=<?php echo $row[1] ?>>
				<input type="hidden" name="burger_size" value=<?php echo $row[2] ?>>
				<input type="hidden" name="burger_price" value=<?php echo $row[3] ?>>
	...
	<section id="footer"> 
        ...
        <div class="border border-light p-3 mb-4">
          ...
          <div class="text-center">
            <button type="button" class="btn btn-primary" style="background-color:green;border-radius: 12px;"> <a href="customer_burgers.php">
				Default</a></button>
